...
import { calculateCeremonyPrice, CEREMONY_HOTEL_VISTA } from "@/lib/pricing";
...
export function CeremonyBookingForm() {
  ...
  const pricing = selectedVehicle
    ? calculateCeremonyPrice(selectedVehicle, hours)
    : null;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-accent">Ceremony Details</h3>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              variant="outline"
              size="icon"
              onClick={() => setHours(Math.max(CEREMONY_HOTEL_VISTA.minHours, hours - 1))}
            >
              -
            </Button>
